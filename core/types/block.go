...
// Package types contains data types related to LCC consensus.
package types
...
// Header represents a block header in the LCC blockchain.
type Header struct {
...
// Block represents an entire block in the LCC blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the LCC RLP block format.
