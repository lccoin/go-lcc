...
// stateObject represents an LCC account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of LCC address of the account
	data     Account
	db       *StateDB
...
// Account is the LCC consensus representation of accounts.
