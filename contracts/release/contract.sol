...
// ReleaseOracle is an LCC contract to store the current and previous
// versions of the go-LCC implementation. Its goal is to allow Geth to
...
contract ReleaseOracle {
  ...
  // updateSigner marks a vote for changing the status of an LCC user, either
