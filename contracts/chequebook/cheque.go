...
// Package chequebook package wraps the 'chequebook' LCC smart contract.
//
...
import (
	...
	"github.com/LCC/go-LCC/contracts/chequebook/contract"
	"github.com/LCC/go-LCC/core/types"
	"github.com/LCC/go-LCC/crypto"
	"github.com/LCC/go-LCC/log"
	"github.com/LCC/go-LCC/swarm/services/swap/swap"
)
...
// Cash cashes the cheque by sending an LCC transaction.
