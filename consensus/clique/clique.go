...
import (
	...
	"github.com/LCC/go-LCC/crypto/sha3"
...
// ecrecover extracts the LCC account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the LCC address
...
// LCC testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // LCC address of the signing key
...
// Author implements consensus.Engine, returning the LCC address recovered
