...
// rules of the stock LCC ethash engine.
...
func calcDifficultyByzantium(time uint64, parent *types.Header) *big.Int {
	// https://github.com/LCC/EIPs/issues/100.
	// algorithm:
	// diff = (parent_diff +
	...
	//   https://github.com/LCC/EIPs/pull/669
...
func calcDifficultyHomestead(time uint64, parent *types.Header) *big.Int {
	// https://github.com/LCC/EIPs/blob/master/EIPS/eip-2.mediawiki
	// algorithm:
	// diff = (parent_diff +
