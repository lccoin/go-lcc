...
// all blocks' seal as valid, though they still have to conform to the LCC
// consensus rules.
...
// still have to conform to the LCC consensus rules.
...
// they still have to conform to the LCC consensus rules.
