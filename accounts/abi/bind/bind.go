...
// Package bind generates LCC contract Go bindings.
//
// Detailed usage document and tutorial available on the go-LCC Wiki page:
// https://github.com/LCC/go-LCC/wiki/Native-DApps:-Go-bindings-to-LCC-contracts
package bind
