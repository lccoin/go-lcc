...
const (
	...
	MessageType_MessageType_LCCGetAddress       MessageType = 56
	MessageType_MessageType_LCCAddress          MessageType = 57
	MessageType_MessageType_LCCSignTx           MessageType = 58
	MessageType_MessageType_LCCTxRequest        MessageType = 59
	MessageType_MessageType_LCCTxAck            MessageType = 60
	...
	MessageType_MessageType_LCCSignMessage      MessageType = 64
	MessageType_MessageType_LCCVerifyMessage    MessageType = 65
	MessageType_MessageType_LCCMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_LCCGetAddress",
	57:  "MessageType_LCCAddress",
	58:  "MessageType_LCCSignTx",
	59:  "MessageType_LCCTxRequest",
	60:  "MessageType_LCCTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_LCCSignMessage",
	65:  "MessageType_LCCVerifyMessage",
	66:  "MessageType_LCCMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_LCCGetAddress":       56,
	"MessageType_LCCAddress":          57,
	"MessageType_LCCSignTx":           58,
	"MessageType_LCCTxRequest":        59,
	"MessageType_LCCTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_LCCSignMessage":      64,
	"MessageType_LCCVerifyMessage":    65,
	"MessageType_LCCMessageSignature": 66,
...
// *
// Request: Ask device for LCC address corresponding to address_n path
// @next PassphraseRequest
// @next LCCAddress
// @next Failure
type LCCGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *LCCGetAddress) Reset()                    { *m = LCCGetAddress{} }
func (m *LCCGetAddress) String() string            { return proto.CompactTextString(m) }
func (*LCCGetAddress) ProtoMessage()               {}
func (*LCCGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *LCCGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *LCCGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an LCC address derived from device private seed
// @prev LCCGetAddress
type LCCAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *LCCAddress) Reset()                    { *m = LCCAddress{} }
func (m *LCCAddress) String() string            { return proto.CompactTextString(m) }
func (*LCCAddress) ProtoMessage()               {}
func (*LCCAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *LCCAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *LCCSignTx) Reset()                    { *m = LCCSignTx{} }
func (m *LCCSignTx) String() string            { return proto.CompactTextString(m) }
func (*LCCSignTx) ProtoMessage()               {}
func (*LCCSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *LCCSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *LCCSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *LCCSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *LCCSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *LCCSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *LCCSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *LCCSignTx) GetDataLength() uint32 {
...
func (m *LCCSignTx) GetChainId() uint32 {
...
func (m *LCCTxRequest) Reset()                    { *m = LCCTxRequest{} }
func (m *LCCTxRequest) String() string            { return proto.CompactTextString(m) }
func (*LCCTxRequest) ProtoMessage()               {}
func (*LCCTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *LCCTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *LCCTxRequest) GetSignatureV() uint32 {
...
func (m *LCCTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *LCCTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev LCCTxRequest
// @next LCCTxRequest
type LCCTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *LCCTxAck) Reset()                    { *m = LCCTxAck{} }
func (m *LCCTxAck) String() string            { return proto.CompactTextString(m) }
func (*LCCTxAck) ProtoMessage()               {}
func (*LCCTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *LCCTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next LCCMessageSignature
// @next Failure
type LCCSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *LCCSignMessage) Reset()                    { *m = LCCSignMessage{} }
func (m *LCCSignMessage) String() string            { return proto.CompactTextString(m) }
func (*LCCSignMessage) ProtoMessage()               {}
func (*LCCSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *LCCSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *LCCSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
func (m *LCCVerifyMessage) Reset()                    { *m = LCCVerifyMessage{} }
func (m *LCCVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*LCCVerifyMessage) ProtoMessage()               {}
func (*LCCVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *LCCVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *LCCVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *LCCVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// Response: Signed message
// @prev LCCSignMessage
type LCCMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *LCCMessageSignature) Reset()                    { *m = LCCMessageSignature{} }
func (m *LCCMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*LCCMessageSignature) ProtoMessage()               {}
func (*LCCMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *LCCMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *LCCMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*LCCGetAddress)(nil), "LCCGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*LCCAddress)(nil), "LCCAddress")
	...
	proto.RegisterType((*LCCSignTx)(nil), "LCCSignTx")
	proto.RegisterType((*LCCTxRequest)(nil), "LCCTxRequest")
	proto.RegisterType((*LCCTxAck)(nil), "LCCTxAck")
	proto.RegisterType((*LCCSignMessage)(nil), "LCCSignMessage")
	proto.RegisterType((*LCCVerifyMessage)(nil), "LCCVerifyMessage")
	proto.RegisterType((*LCCMessageSignature)(nil), "LCCMessageSignature")
