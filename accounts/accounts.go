...
// Package accounts implements high level LCC account management.
package accounts
...
// Account represents an LCC account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // LCC account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain LCC.ChainStateReader)
