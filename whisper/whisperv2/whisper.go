...
import (
	...
	"github.com/LCC/go-LCC/crypto/ecies"
	"github.com/LCC/go-LCC/event/filter"
...
// Whisper represents a dark communication interface through the LCC
...
// New creates a Whisper client ready to communicate through the LCC P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
