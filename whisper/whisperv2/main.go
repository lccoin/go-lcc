...
import (
	...
	"github.com/LCC/go-LCC/logger"
	"github.com/LCC/go-LCC/p2p"
	"github.com/LCC/go-LCC/p2p/nat"
	"github.com/LCC/go-LCC/whisper"
)
...
func main() {
	...
	// Create an LCC peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting LCC peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start LCC peer: %v.\n", err)
		os.Exit(1)
	}
