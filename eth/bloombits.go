...
import (
	...
	"github.com/LCC/go-LCC/common/bitutil"
...
const (
	// bloomServiceThreads is the number of goroutines used globally by an LCC
...
func (eth *LCC) startBloomHandlers() {
...
// for the LCC header bloom filters, permitting blazing fast filtering.
