...
import (
	...
	"github.com/LCC/go-LCC/core/state"
	...
	"github.com/LCC/go-LCC/trie"
)

const defaultTraceTimeout = 5 * time.Second

// PublicLCCAPI provides an API to access LCC full node-related
// information.
type PublicLCCAPI struct {
	e *LCC
}

// NewPublicLCCAPI creates a new LCC protocol API for full nodes.
func NewPublicLCCAPI(e *LCC) *PublicLCCAPI {
	return &PublicLCCAPI{e}
}

// Etherbase is the address that mining rewards will be send to
func (api *PublicLCCAPI) Etherbase() (common.Address, error) {
	return api.e.Etherbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Etherbase)
func (api *PublicLCCAPI) Coinbase() (common.Address, error) {
	return api.Etherbase()
}

// Hashrate returns the POW hashrate
func (api *PublicLCCAPI) Hashrate() hexutil.Uint64 {
...
func NewPublicMinerAPI(e *LCC) *PublicMinerAPI {
...
func NewPrivateMinerAPI(e *LCC) *PrivateMinerAPI {
...
// PrivateAdminAPI is the collection of LCC full node-related APIs
...
// admin methods of the LCC service.
func NewPrivateAdminAPI(eth *LCC) *PrivateAdminAPI {
...
// PublicDebugAPI is the collection of LCC full node APIs exposed
...
// related public debug methods of the LCC service.
func NewPublicDebugAPI(eth *LCC) *PublicDebugAPI {
...
// PrivateDebugAPI is the collection of LCC full node APIs exposed over
...
// private debug methods of the LCC service.
func NewPrivateDebugAPI(config *params.ChainConfig, eth *LCC) *PrivateDebugAPI {
