...
type wizard struct {
	...
	services map[string][]string   // LCC services known to be running on servers
...
// converts it to an LCC address. If an empty line is entered, the default
// value is returned.
