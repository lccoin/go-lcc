...
// setting up a new or managing an existing LCC private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your LCC private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new LCC network down to  |")
	...
	log.Info("Administering LCC network", "name", w.network)
