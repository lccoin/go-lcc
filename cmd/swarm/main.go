...
import (
	...
	"github.com/LCC/go-LCC/cmd/utils"
	"github.com/LCC/go-LCC/common"
	"github.com/LCC/go-LCC/console"
	"github.com/LCC/go-LCC/contracts/ens"
	"github.com/LCC/go-LCC/crypto"
	"github.com/LCC/go-LCC/ethclient"
	"github.com/LCC/go-LCC/internal/debug"
	...
	"github.com/LCC/go-LCC/swarm"
	bzzapi "github.com/LCC/go-LCC/swarm/api"
...
var (
	...
	SwarmSwapAPIFlag = cli.StringFlag{
		Name:  "swap-api",
		Usage: "URL of the LCC API provider to use to settle SWAP payments",
	}
	...
	EnsAPIFlag = cli.StringFlag{
		Name:  "ens-api",
		Usage: "URL of the LCC API provider to use for ENS record lookups",
...
var app = utils.NewApp(gitCommit, "LCC Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.HideVersion = true // we have a command to print the version
	app.Copyright = "Copyright 2013-2016 The go-LCC Authors"
...
Export a local chunk database as a tar archive (use - to send to stdout).
    ...
    swarm db export ~/.LCC/swarm/bzz-KEY/chunks chunks.tar

The export may be quite large, consider piping the output through the Unix
pv(1) tool to get a progress bar:

    swarm db export ~/.LCC/swarm/bzz-KEY/chunks - | pv > chunks.tar
`,
				},
				{
					Action:    dbImport,
...
Import chunks from a tar archive into a local chunk database (use - to read from stdin).
    ...
    swarm db import ~/.LCC/swarm/bzz-KEY/chunks chunks.tar

The import may be quite large, consider piping the input through the Unix
pv(1) tool to get a progress bar:

    pv chunks.tar | swarm db import ~/.LCC/swarm/bzz-KEY/chunks -
`,
				},
				{
					Action:    dbClean,
