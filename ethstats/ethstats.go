...
import (
	...
	"github.com/LCC/go-LCC/common/mclock"
...
// Service implements an LCC netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.LCC      // Full LCC service if monitoring a full node
	les    *les.LightLCC // Light LCC service if monitoring a light node
...
func New(url string, ethServ *eth.LCC, lesServ *les.LightLCC) (*Service, error) {
